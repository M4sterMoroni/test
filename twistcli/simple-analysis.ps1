...
## Recommendations
1. **User Context**: Ensure container runs as non-root user
2. **Port Security**: Minimize exposed ports
3. **Environment Variables**: Review for sensitive information
4. **WAAS Integration**: Configure proper protection

## Next Steps
1. Address security findings
2. Configure WAAS protection
3. Set up monitoring
4. Regular security assessments

---
*Report generated by Prisma Cloud Security Analysis*
"@
...
Write-Host "`n📊 Security Findings: $($securityFindings.Count)" -ForegroundColor Yellow
